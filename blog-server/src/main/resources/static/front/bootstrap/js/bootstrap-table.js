            ...
            _createClass(BootstrapTable, [{
                ...
                value: function initBody(fixedScroll) {
                    ...
                    this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
                        ...
                        var rowIndex = $tr.data('index.html.jsp');
                    ...
                    this.$body.find('> tr[data-index] > td > .detail-icon').off('click').on('click', function (e) {
                        ...
                        _this8.toggleDetailView($(e.currentTarget).parent().parent().data('index.html.jsp'));
                    ...
                    this.$selectItem.off('click').on('click', function (e) {
                        ...
                        _this8._toggleCheck($this.prop('checked'), $this.data('index.html.jsp'));
                    });
                        ...
                        var _loop = function _loop(key) {
                            ...
                            _this8.$body.find('>tr:not(.no-records-found)').each(function (i, tr) {
                                ...
                                $td.find(el).off(name).on(name, function (e) {
                                    var index = $tr.data('index.html.jsp');
                ...
                value: function updateRows() {
                    ...
                    this.$selectItem.each(function (i, el) {
                        _this11.data[$(el).data('index.html.jsp')][_this11.header.stateField] = $(el).prop('checked');
                    });
                }
            }, {
                key: "resetRows",
                ...
                value: function insertRow(params) {
                    if (!params.hasOwnProperty('index.html.jsp') || !params.hasOwnProperty('row')) {
                        return;
                    }
                ...
                value: function updateRow(params) {
                    ...
                    try {
                        for (var _iterator5 = allParams[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            ...
                            if (!_params.hasOwnProperty('index.html.jsp') || !_params.hasOwnProperty('row')) {
                                continue;
                            }
                ...
                value: function updateCell(params) {
                    if (!params.hasOwnProperty('index.html.jsp') || !params.hasOwnProperty('field') || !params.hasOwnProperty('value')) {
                        return;
                    }
                ...
                value: function _toggleRow(params, visible) {
                    ...
                    if (params.hasOwnProperty('index.html.jsp')) {
                ...
                value: function expandAllRows() {
                    ...
                    for (var i = 0; i < trs.length; i++) {
                        this.expandRow($(trs[i]).data('index.html.jsp'));
                    }
                }
            }, {
                key: "collapseAllRows",
                value: function collapseAllRows() {
                    ...
                    for (var i = 0; i < trs.length; i++) {
                        this.collapseRow($(trs[i]).data('index.html.jsp'));
                    }
                }
            }, {
